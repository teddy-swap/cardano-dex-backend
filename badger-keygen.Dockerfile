...
RUN rm -rf /root/.cabal/store/ghc-8.10.7/incoming
ENTRYPOINT $(find /root/.cabal/store/ghc-8.10.7 -name key-gen-*)/bin/key-gen "/mnt/teddyswap/secret.json" "/mnt/teddyswap/payment.skey" "password"